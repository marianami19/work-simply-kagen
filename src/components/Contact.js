		...
		<div className="row">
			<div className="col-lg-6">
				...
				<form className="d-flex pt-4 me-lg-5">
					<input aria-label="input" className="form-control me-2" placeholder="Telephone Number" type="tel"/> <button className="btn btn-primary text-nowrap" type="submit">Call Me</button>
				</form>
			</div>
			<div className="col-lg-6 mt-4 mt-lg-0">
				<p>
                Ready to elevate your business? Schedule a consultation today or request a custom quote tailored to your needs!</p>
				<div className="d-lg-flex text-primary mt-3 mt-lg-5">
					<a className="text-decoration-none me-4 fs-5 fw-bold" href="tel:+1(234)%20567-89-01">+1(234) 567-89-10</a> <a className="text-decoration-none fs-5 fw-bold" href="mailto:info@collector.com">hello@yourdomain.com</a>
				</div>
			</div>
		</div>
	</div>
